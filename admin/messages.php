...
// Stats: Sales by Hour from phonepe
$sales_by_hour = "SELECT HOUR(payment_time) AS hname,
...
if (!$res_sales_by_hour) {
    die("<p style='color:red;'>❌ SQL Error: " . mysqli_error($conn) . "</p>");
}

// Display results
echo "<h3>Sales by Hour</h3>";
while ($row = mysqli_fetch_assoc($res_sales_by_hour)) 
    echo "Hour: " . $row['hname'] . " - Total Sales: ₹" . $row['total_sales'] . "<br>";
