...
// Update payment_status in order_manager where there is a matching transaction_id in phonepe
$payment_status_query = "
    UPDATE order_manager
    INNER JOIN phonepe 
    ON phonepe.transaction_id = order_manager.transaction_id
    SET order_manager.payment_status = 'successful'
";
...
if ($payment_status_query_result) {
