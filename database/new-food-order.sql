...
CREATE TABLE `phonepe` (
  ...
  `tran_id` VARCHAR(50) NOT NULL,           -- Transaction ID (unique)
  `username` VARCHAR(100) NOT NULL,         -- Customer's username
  `customer_name` VARCHAR(100) NOT NULL,    -- Customer's full name
  `customer_email` VARCHAR(100) NOT NULL,   -- Customer's email
  `amount` DECIMAL(10,2) NOT NULL,          -- Total amount
  `status` VARCHAR(50) NOT NULL,            -- Payment status (e.g., Pending, Successful)
  `phone_number` VARCHAR(20) NOT NULL,      -- Customer's phone number
  `order_date` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,  -- Order timestamp
  `payment_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,  -- Payment timestamp
  `payment_method` VARCHAR(50) NOT NULL     -- Payment method (e.g., PhonePe, UPI, etc.)
...
VALUES 
('TXN12345', 'johndoe', 'John Doe', 'johndoe@example.com', 500.00, 'Pending', '9876543210', NOW(), 'PhonePe');
...
(1, 'lavishetty nikhilesh', 'nikhilesh37', 'nikhilesh37');
...
(15, 'Table 3', 763.00, 'EI-PAY-GKKQXXZ42C', '2022-02-09 10:36:18', 'Successful', 'Delivered'),
(16, 'Table 2', 460.00, 'EI-PAY-5SA6TNEO29', '2022-02-09 12:14:30', 'Successful', 'Delivered'),
(18, 'Table 4', 450.00, 'EI-PAY-65IYLWUW2S', '2022-02-09 14:11:26', 'Successful', 'Pending'),
...
(`tran_id`, `username`, `customer_name`, `customer_email`, `address`, `city`, `phone`, `total_amount`, `payment_status`, `order_date`) 
VALUES
('TXN1001', 'johndoe', 'John Doe', 'john@example.com', '123 Main Street', 'Mumbai', '9876543210', 500.00, 'Pending', NOW());
...
(1,'lavishetty nikhilesh', 'nikhilesh@gmail.com', 'om nager', 'surat', 9316184016, 'nikhilesh123',' nikhilesh123');
--
